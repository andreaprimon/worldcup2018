...
import com.projectemplate.worldcup2014.AlarmReceiver;
...
import com.projectemplate.worldcup2014.adapter.EventAdapter;
...
import com.projectemplate.worldcup2014.object.EventInfo;
import com.projectemplate.worldcup2014.object.Match;
import com.projectemplate.worldcup2014.object.Stadium;
import com.projectemplate.worldcup2014.utility.DialogUtility;
import com.projectemplate.worldcup2014.utility.NoScrollListView;
import com.projectemplate.worldcup2014.utility.StringUtility;
...
public class InfoMatchActivity extends BaseActivity {
	...
	private void getListEvent() {
		...
		String json = DatabaseUtility.getJsonContent(
				self,
		...
		try {
			...
			lblGoal2.setText(ParserUitility.getStringValue(obj,
					"match_guest_score"));
			listEvent = ParserUitility.parserListEvent(new JSONObject(json));
		...
		if (listEvent == null || listEvent.size() == 0)
			Toast.makeText(InfoMatchActivity.this,
					R.string.msg_cannot_get_list_event, Toast.LENGTH_LONG)
					.show();
		eventAdapter = new EventAdapter(InfoMatchActivity.this, listEvent,
				currentMath);
